...
QUnit.module('Тестируем функцию sorting', function () {
	...
	QUnit.test('sorting сортирует с отрицательными числами', function (assert) {
		const initial = [
			{prop1: 30},
			{prop1: -1000},
			{prop1: -4},
	...
	QUnit.test('sorting Работает правильно со специальными константами', function (assert) {
		const initial = [
			{prop1: Infinity},
			{prop1: 100000},
			{prop1: 0}
		];
		const actual = sorting(initial, ['techno']);
